...
export function getMetricMetaInfo(metric) {
  const info = {
    run:{
      ...
      type: 'steppers',
      getIcon() {
        return (<View style={[styles.iconContainer, {backgroundColor:red}]}>
    ...
    swim: {
      ...
      type: 'steppers',
      getIcon() {
        return (<View style={[styles.iconContainer, {backgroundColor:blue}]}>
...
export function getDailyReminderValue() {
  return {
    today: "Don't forget to log data today!"
  }
}
